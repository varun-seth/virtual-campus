...
export declare const SUPPORTED_FRAMEWORKS: {
    ...
    nest: RequestAdapter<import("@nestjs/common").INestApplication<any>>;
...
export declare const createMiddleware: (server: ViteDevServer, config: VitePluginNodeConfig) => Promise<Connect.HandleFunction>;
