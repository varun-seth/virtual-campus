...
export type { SendChatMessageOptions, SendLocalChatMessageOptions, SendBubbleChatMessageOptions, } from "@workadventure/shared-utils";
...
declare const wa: {
    ...
    chat: import("./front/Api/Iframe/chat").WorkadventureChatCommands<import("./iframe_api").PublicPlayerState>;
    ...
    state: import("./front/Api/Iframe/state").WorkadventureStateCommands & import("./iframe_api").RoomState;
